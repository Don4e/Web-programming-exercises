...
public class NationalParkController {
    ...
    public NationalParkController(ParkLocationService parkLocationService, NationalParkService nationalParkService) {
    ...
    public String showEdit(@PathVariable Long id,
                           Model model) {
        model.addAttribute("park", this.nationalParkService.findById(id));
        model.addAttribute("locations", this.parkLocationService.listAll());
        model.addAttribute("parkTypes", ParkType.values());
        return "form";
    }
    ...
    public String update(@PathVariable Long id,
                         ...
                         @RequestParam ParkType parkType,
                         @RequestParam Long locationId) {
        this.nationalParkService.update(id, name, areaSize, rating, parkType, locationId);
        return "redirect:/national-parks";
    }
    ...
    public String delete(@PathVariable Long id) {
        this.nationalParkService.delete(id);
        return "redirect:/national-parks";
    }
    ...
    public String close(@PathVariable Long id) {
        this.nationalParkService.close(id);
        return "redirect:/national-parks";
    }
}
