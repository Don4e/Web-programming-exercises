...
public class StartupController {
    ...
    public String listAll(@RequestParam(required = false) String name,
                          ...
                          Model model) {
        Page<Startup> products = startupService.findPage(name, valuation, yearFounded, industry, founderId, pageNum - 1, pageSize);
    ...
    public String showEdit(@PathVariable Long id, Model model) {
        model.addAttribute("startup", this.startupService.findById(id));
        model.addAttribute("founders", this.founderService.listAll());
        model.addAttribute("industries", Industry.values());
        return "form";
    }
    ...
    public String create(@RequestParam String name,
        ...
        this.startupService.create(name, valuation, yearFounded, industry, founderId);
    ...
    public String update(@PathVariable Long id,
                         ...
                         @RequestParam Industry industry,
                         @RequestParam Long founderId) {
        this.startupService.update(id, name, valuation, yearFounded, industry, founderId);
        return "redirect:/startups";
    }
    ...
    public String deactivate(@PathVariable Long id) {
        this.startupService.deactivate(id);
        return "redirect:/startups";
    }
}
